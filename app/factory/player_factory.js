...
player_factory.prototype.calculateStatsForPlayer = function (player, bot) {
    ...
    function solver(class_by_name) {
        player_stats.hp = class_by_name.hpFormula()(player.attributes, player.level);
        player_stats.flee = class_by_name.fleeFormula()(player.attributes, player.level);
        player_stats.iniciative_bonus = 0;
        player_stats.autoAttackDmg = class_by_name.autoAttackFormula()(player.attributes, player.level);
        player_stats.accuracy = class_by_name.accuracyFormula()(player.attributes, player.level);
